...
export default class ColorThief {
  ...
  */
  ...
  getColorAsync(imageUrl, quality) {
    const thief = this
		return this.getImageData(imageUrl).then((imageData) =>{
...
//                    console.log('empty box');
  ...
  CMap.prototype = {
      ...
      palette() {
          return this.vboxes.map((vb) => { return vb.color; });
      },
      size() {
      ...
      forcebw() {
          // XXX: won't  work yet
          var {vboxes} = this;
          vboxes.sort((a,b) => { return pv.naturalOrder(pv.sum(a.color), pv.sum(b.color));});
...
//            console.log('wrong number of maxcolors');
      ...
      var vbox = vboxFromPixels(pixels, histo);
          var pq = new PQueue((a,b) => { return pv.naturalOrder(a.count(), b.count()); });
      pq.push(vbox);
